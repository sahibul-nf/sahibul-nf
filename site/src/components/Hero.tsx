...
export function Hero({ onOpenResume }: { onOpenResume: () => void }) {
  ...
  const resumeBtnRef = useMagnetic<HTMLButtonElement>(0.18)
        ...
        >
          ...
          <motion.div variants={childFadeUp} className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-cyan-deep/40 bg-foam/90 px-5 py-3 text-sm font-semibold text-cyan-deep backdrop-blur-sm transition-colors duration-300 hover:border-cyan-deep hover:bg-cyan-deep/10"
              style={{
                transition:
            ...
            <a
              ...
              className="inline-flex items-center rounded-full border border-line bg-foam/70 px-5 py-3 text-sm font-semibold text-ink backdrop-blur-sm transition-colors duration-300 hover:border-cyan-deep/40 hover:bg-foam"
              style={{
                transition:
                  'transform 180ms ease, background-color 300ms ease, border-color 300ms ease',
              }}
